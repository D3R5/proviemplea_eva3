...
/**
 * PersonaIdiomas Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PersonaIdiomas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Persona_idiomas';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['nivel']) && !in_array($this->container['nivel'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'nivel', must be one of '%s'",
    ...
    {
        $allowedValues = $this->getNivelAllowableValues();
        if (!is_null($nivel) && !in_array($nivel, $allowedValues, true)) {
