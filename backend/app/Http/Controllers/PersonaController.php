...
class PersonaController extends Controller
{
    ...
    #[OA\Parameter(name: "validado", description: "Filtrar por validación", in: "query", required: false, schema: new OA\Schema(type: "boolean"))]
    ...
    #[OA\Response(response: 200, description: "Listado exitoso", content: new OA\JsonContent(type: "array", items: new OA\Items(ref: "#/components/schemas/PersonaCVCiego")))]
    ...
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: "#/components/schemas/PersonaInput"))]
    #[OA\Response(response: 201, description: "Persona creada", content: new OA\JsonContent(ref: "#/components/schemas/Persona"))]
    ...
    #[OA\Response(response: 200, description: "Persona encontrada", content: new OA\JsonContent(ref: "#/components/schemas/Persona"))]
