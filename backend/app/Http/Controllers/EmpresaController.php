...
class EmpresaController extends Controller
{
    ...
    #[OA\Response(response: 200, description: "Listado exitoso", content: new OA\JsonContent(type: "array", items: new OA\Items(ref: "#/components/schemas/Empresa")))]
    ...
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: "#/components/schemas/EmpresaInput"))]
    #[OA\Response(response: 201, description: "Empresa creada", content: new OA\JsonContent(ref: "#/components/schemas/Empresa"))]
    ...
    #[OA\Response(response: 200, description: "Empresa encontrada", content: new OA\JsonContent(ref: "#/components/schemas/Empresa"))]
