...
class AdministracionController extends Controller
{
    ...
    #[OA\Response(response: 200, description: "Listado exitoso", content: new OA\JsonContent(type: "array", items: new OA\Items(ref: "#/components/schemas/ContactoSolicitado")))]
    ...
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitadoInput"))]
    #[OA\Response(response: 201, description: "Contacto registrado", content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitado"))]
    ...
    #[OA\Response(response: 200, description: "Estado actualizado", content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitado"))]
